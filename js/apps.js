...
const sttaddr = "0x73dD9eEbFbD74BA69fBC92046a49c70ECd549222";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x73dD9eEbFbD74BA69fBC92046a49c70ECd549222";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://liquiditytoken.net?ref=' + document.getElementById('refaddress').value;
        }
    }
}
